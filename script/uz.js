...
function openDialogText(content,btnText,callback){
	openDialogAlert({
		texts: {
			content: content,
			leftBtnTitle: btnText
		},
		styles: {
			bg: '#F8F8F8',
			w: 325,
...
function openDialogComfirm(content,callback,leftBtnTitle,rightBtnTitle){
	leftBtnTitle = leftBtnTitle || '取消';
	rightBtnTitle = rightBtnTitle || '确定';
	openDialogAlert({
		texts: {
			content: content,
